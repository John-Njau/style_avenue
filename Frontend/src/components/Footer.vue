        ...
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p class="fw-bold">Make Up . Fragrance . Beauty</p>
            </div>
            <!-- Grid column -->
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <i class="fas fa-home me-3"></i> Moi Avenue Topaz Building G15
              </p>
              <p>
                <i class="fas fa-envelope me-3"></i>
                info@styleavenue.com
              </p>
              <p><i class="fas fa-phone me-3"></i> + 254 701911030</p>
              <p><i class="fas fa-print me-3"></i> + 254 701911030</p>
            </div>
            <!-- Grid column -->
          </div>
          <!-- Grid row -->
